                ...
                <li>
                    <div class="relative pb-8">
                        ...
                        <div class="relative flex items-start space-x-3">
                            <div class="relative">
                                <img class="h-10 w-10 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white" src="https://avatars.githubusercontent.com/u/18025595?v=4" alt="">
                        ...
                        <div class="relative flex items-start space-x-3">
                            ...
                            <div class="min-w-0 flex-1 py-1.5">
                                <div class="text-sm text-gray-500">
                                    <a href="#" class="font-medium text-gray-900">Goodman Luphondo</a>
                                    registered
                                    <a href="#" class="font-medium text-gray-900">goodmanluphondo.com</a>
                                    <span class="whitespace-nowrap">2y ago</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="text-sm leading-8 text-gray-500">
                                    ...
                                    <span class="mr-0.5">
                                        <a href="#" class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-0.5 text-sm">
                                            ...
                                            <span class="ml-3.5 font-medium text-gray-900">Cloudflare</span>
                                        </a>
                                        <a href="#" class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-0.5 text-sm">
                                            <span class="absolute flex-shrink-0 flex items-center justify-center">
                                            <span class="h-1.5 w-1.5 rounded-full bg-indigo-500" aria-hidden="true"></span>
                                            </span>
                                            <span class="ml-3.5 font-medium text-gray-900">Laravel Forge</span>
                                        </a>
                                    </span>
                                    <span class="whitespace-nowrap">1y ago</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative flex items-start space-x-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <div>
                                    ...
                                    <p class="mt-0.5 text-sm text-gray-500">Recorded a thought 2mo ago</p>
                                </div>
                                <div class="mt-2 text-sm text-gray-700">
                                    <p>Work is hectic. I will one day get the right amount of time and work on this website.</p>
                                </div>
                            </div>
                        </div>
                    </div>
